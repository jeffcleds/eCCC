...
<head>
    ...
    <link rel="stylesheet" href="programhead_settingsstyles.css">
</head>
<body>
                            ...
                            <div class="form-row">
                                <div class="form-col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first-name" name="FirstName" value="<?php echo htmlspecialchars($firstName); ?>"disabled>
                                    </div>
                                </div>
                                <div class="form-col">
                                    <div class="form-group">
                                        <label for="last-name">Last Name</label>
                                        <input type="text" class="form-control" id="last-name" name="LastName" value="<?php echo htmlspecialchars($lastName); ?>"disabled>
                                    </div>
                                </div>
                            </div>
